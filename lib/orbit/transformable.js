  ...
  extend: function(object, actions) {
    if (object._transformable === undefined) {
      ...
      object.settleTransforms = function() {
        if (this._transactionQueue.current && this._transactionQueue.content.length > 1) {
          console.log('>>>>>>>> ', this._transactionQueue.content.length);
        }
        //   console.log('!!!!!!!! Transformable#settleTransforms', this.id);
        //   return this._transactionQueue.current.data.complete;
        // } else {
        console.log('???????? Transformable#settleTransforms', this.id);
