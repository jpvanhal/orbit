...
var Source = Class.extend({
  ...
  _add: function(type, data) {
    ...
    return this.transaction({op: 'add', path: path, value: record}).then(function() {
  ...
  _update: function(type, data) {
    ...
    return this.transaction({op: 'replace', path: path, value: record});
  },
  ...
  _patch: function(type, id, property, value) {
    ...
    return this.transaction({op: 'replace', path: path, value: value});
  },
  ...
  _remove: function(type, id) {
    ...
    return this.transaction({op: 'remove', path: path});
  },
  ...
  _addLink: function(type, id, key, value) {
    ...
    return this.transaction(this._addLinkOp(type, id, key, value));
  },
  ...
  _removeLink: function(type, id, key, value) {
    ...
    return this.transaction(this._removeLinkOp(type, id, key, value));
  },
